      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: 'http://localhost:5555/api/v1/users/login',
            data: {
              email: email,
              password: password
            }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: 'http://localhost:5555/api/v1/users/logout'
          });
        case 3:
          res = _context2.sent;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:5555/api/v1/users/updateMyPassword' : 'http://localhost:5555/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NVBQtD7E7gvrPOhiEdwIwhzoQ0xHAD4Gq3t2YDv8T5bcGaOxCBJ7EpogEPGcYEBBHGxMoP4JcVOl51d1k22GaMn00R2jk8dOg');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://localhost:5555/api/v1/bookings/checkout-session/".concat(productId));
        case 3:
...
var closeModel = document.querySelector('.closeModalBtn');
var model = document.querySelector('.create-model');
var overlay = document.querySelector('.overlay');
var searchInput = document.getElementById('search-box');
var copyright = document.querySelector('.footer-company-copy-right');
...
var toggleBox = document.getElementById('toggle-box-checkbox');
var loginForm = document.querySelector('.form-login');
var logOutBtn = document.querySelector('.nav-btn-logout');
...
searchInput.addEventListener('keyup', function (e) {
  ...
  fetch('/', {
    ...
    payload.forEach(function (item, index) {
      ...
      searchResults.innerHTML += "<form action=\"/product/".concat(item.slug, "\" method=\"get\">\n                    <button class=\"title-btn\" type=\"submit\">\n                        <p>").concat(item.title, "</p>\n                    </button>\n                </form>");
    });
    return;
  });
  searchResults.innerHTML = ' ';
